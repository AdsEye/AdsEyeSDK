#import "AdsEyeTradPlusResourceSupport.h"
#import "resource_bundle_accessor.h"
#import <objc/runtime.h>

@implementation AdsEyeTradPlusResourceSupport

static IMP AdsEyeTradPlusOriginalBundleForClass = NULL;
...
static NSBundle *AdsEyeTradPlusBundleForClass(id self, SEL command, Class targetClass) {
    if (AdsEyeIsTradPlusClass(targetClass)) {
        // TradPlus 是静态 XCFramework，资源需要从当前 SPM target 的资源 Bundle 查找。
        return SWIFTPM_MODULE_BUNDLE;
    }

    NSBundle *(*originalImplementation)(id, SEL, Class) = (void *)AdsEyeTradPlusOriginalBundleForClass;
...
+ (void)load {
    ...
    dispatch_once(&onceToken, ^{
        ...
        AdsEyeTradPlusOriginalBundleForClass = method_getImplementation(method);
